...
int main(int argc, char **argv)
{
    ...
    if (argc < 7)
    {
        cout << "arg1 = input path, arg2 = number of threads"
             << ", arg3 = degree ratio, arg4 = min_size, arg5 = time delay threshold, arg6 = summary output path (file or dir)" << endl;
        return -1;
    }
    ...
    cout << "THREAD_OUTPUT_DIR:" << THREAD_OUTPUT_DIR << endl;
