...
public:
	...
	void reset_max_clique_tracking();
	int get_max_clique_size() const;
	double get_max_clique_time() const;
	const std::vector<int>& get_max_clique_vertices() const;
	void set_runtime_limit(std::chrono::steady_clock::time_point, double);
...
private:
	...
	double gamma;
	std::chrono::steady_clock::time_point max_clique_start_time;
	int max_clique_size;
	double max_clique_time;
	std::vector<int> max_clique_vertices;
	std::chrono::steady_clock::time_point runtime_limit_start_time;
	double max_runtime_seconds;
	bool runtime_limited;
	bool timed_out;
